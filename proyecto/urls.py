...
urlpatterns = [
    ...
    path('gestion-usuario/eliminado',users.gestionEliminado,name='gesEliminado'),
    ...
    path('clinica-registro/',clinica.registro,name="clinicaRegistro"),
    path('clinica/registros',clinica.registros,name="clinicaRegistros"),
    path('clinica/eliminar-registro', clinica.eliminar,name="clinicaEliminar"),
    path('clinica/eliminado',clinica.eliminado,name="clinicaEliminado")
